...
void set_valid(cache_set *set, uint page_num);
BOOL is_valid(cache_set *set, uint page_num);

void set_writed(cache_set *set, uint page_num);
BOOL is_writed(cache_set *set, uint page_num);

void set_tag(cache_set *set, uint page_num, uint tag);
